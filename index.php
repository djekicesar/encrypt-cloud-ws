...
<html lang="en">
<head>
    <title>Encrypt Cloud Web Service Documentation</title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <div class="branding">
                    <h1 class="logo">
                        ...
                        <span class="text-highlight">EncryptCloudAPI</span><span class="text-bold">Docs</span>
                    </h1>
                </div><!--//branding-->
                <div class="tagline">
                    <p>Documentation of Encrypt Cloud Web Service</p>
                ...
                <div class="social-container">
	                ...
	                <div class="github-btn mb-2">
						<a class="github-button" href="https://github.com/djekicesar/encrypt-cloud-ws" data-size="large" aria-label="Star xriley/PrettyDocs-Theme on GitHub">Star</a>
                        <a class="github-button" href="https://github.com/djekicesar" data-size="large" aria-label="Follow @xriley on GitHub">Follow @djekicesar</a>
	                </div>
	                <!-- Replace with your Twitter Button -->
                    <div class="twitter-tweet">
                        <a href="https://twitter.com/3rdwave_themes?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-show-count="false">Follow @djeki_cesar</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div><!--//tweet-->
        ...
        <section class="cards-section text-center">
            <div class="container">
                ...
                <div class="intro">
                    <p>Welcome to EncryptCloudDocs. This landing page is an example of how you can use a card view to present segments of your documentation. You can customise the icon fonts based on your needs.</p>
